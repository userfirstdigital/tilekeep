...
use windows::Win32::UI::Input::KeyboardAndMouse::{
    RegisterHotKey, UnregisterHotKey, MOD_NOREPEAT, MOD_SHIFT, MOD_WIN, VIRTUAL_KEY, VK_B, VK_F, VK_G, VK_K, VK_L,
    VK_N, VK_Q,
};
...
impl Hotkey {
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            Hotkey::StackAtCursor => "Win+Shift+G  stack the foreground window at the cursor",
